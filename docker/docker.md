...
1. ** . Docker Architecture ? <br>
A. Refer notes

2. ** . Docker Execution Steps ? <br>
A.  Refer notes

3. what is docker.? why we use it.? what is required to run docker.? <br>
...
4. where do you store docker images so that it is easily sharable.? <br>
A. Generally it is stored in docker hub registry

5. How many ways can we share docker images to the user.? <br>
...
7. what is docker volume.? how is it useful.? <br>
...
11. Docker Client Vs Docker Deamon Vs Docker Engine.?  <br>
