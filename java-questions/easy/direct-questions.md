...
4. What is unicode system ? why two bytes are allocated for each character ? <br>
...
5. Can any class be specified as datatype ? For instance 'String' class <br>
A. Yes, all classes are specified as user defined datatype

6. Default datatype for non-fractional numbers & fractional ones ? <br>
A. non-factional - Integer, fractional - Double

7. How datatypes declaration transited from java-8 to java-11 and above ? <br>
A. 'var' keyword is used for representing the datatype reference which will decided at runtime

8. Can you explain where to use '==' vs .equals() method ? <br>
...
9. Can you explain with example between operators '|' and '||' ? <br>
...
10. What is ternary operator ? when to use ? any advantage ? <br>
...
11. What is instanceOf operator ? When to use ? any advantage ? <br>
...
12. What decides the execution flow of expression ? <br>
A. BODMAS rule

13. what are statements and loops ? <br>
...
14. Difference between while and do-while loop ? <br>
...
15. How would you write infinite for-loop, while & do-while loop, where are they useful ? <br>
...
16. What will happen if i run continues loop basically infinite loop ? <br>
A. Heap will run out of memory and out of memory error will come

17. In which cases for loop with indexes are useful ? <br>
A. Generally, when you want to toggle the data with indexes say alternate numbers, every three number of array etc..

18. Give me usecase where we use switch statement ? <br>
...
19. Difference between return and system.exit() ? <br>
...
20. In which case finally block executes, if the statements are called before them ? <br>
...
21. How many ways can we terminate the program ? <br>
...
22. What are the ways in which we you can create string ? <br>
